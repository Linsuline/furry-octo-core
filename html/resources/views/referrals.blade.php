<html lang="en">
    <head>
        ...
        <title>Referrals :: csgoclique.com</title>
        <meta property="og:title" content="csgoclique.com" />
        ...
        <meta name="websocket" content="http://csgoclique.com:8080" /> 
...
<div class="top-navigation">
    ...
    <div class="main-wrapper">
        <main>
			...
			<div class="t-alert">You can generate your own code by pressing<font color="#00ffe4"><b>&nbsp;"GET"</b></font> to get your <b>7</b> digit code!</div>
        ...
        <div class="top">
            <div class="top-box">
                ...
                <div class="box">
                    <label for="set-code">Get your own 7 digit code by pressing the <font color="#00ffe4"><b>"GET"</b></font> button</label>
                    <div class="group-input">
                ...
                <div class="box">
                    <label>Put <a class="lime" href="http://steamcommunity.com/my/edit">csgoclique.com</a> in your name for 30 coins</label>
                    <div class="group-input">
...
@endif
                ...
                <div class="box">
                    <label>Join our <a href="http://steamcommunity.com/groups/cs_gon1" target="_blank" style="color: #00ffe4;">Steam Group</a> in your for 30 coins</label>
                    <div class="group-input">
...
<div class="chat">
	...
	<div class="footer" style="width: 303px;">
      <div class="data">
        <div class="social">
          <a href="https://twitter.com/VAMINyt" target="_blank"><i class="fa fa-twitter"></i></a>
          <a href="http://steamcommunity.com/id/VAMIN" target="_blank"><i class="fa fa-steam"></i></a>
        </div>

        <div class="copyright copyright0">&copy; csgoclique.com 2017</div>
        
        <div class="legal">
          <a href="/terms" target="_blank">Terms</a>
           <a class="chat-info" style="cursor: pointer;">Rules</a>
          <a href="http://www.responsiblegambling.org/" target="_blank">Responsible Gambling</a>
        </div>
...
<div class="popup">
    <div class="popup-inner">
        ...
        <div class="content">
            ...
            <p>2 - Please forward all problems to: <b style="color: #00ffe4;text-decoration: none !important;text-transform: none !important;">support@csgoclique.com</b></p>
			<p>3 - Please forward all Business Inquiries to: <b style="color: #00ffe4;text-decoration: none !important;text-transform: none !important;">business@csgoclique.com</b></p>
			...
			<p>6 - csgoclique.com is not responsible for trade/account bans that may occur as a resulting of accepting items from our bots.</p>
			<p>7 - csgoclique.com assumes no responsibility for missed bets as a result of network latency or disconnections. Always ensure a stable connection before placing bets. Avoid placing important bets at the last second.</p>
