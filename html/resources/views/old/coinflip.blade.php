<html lang="en">
    <head>
        ...
        <title>csgon1.com - Coin Flip</title>
...
@endif        <ul class="navbar-pages">
		...
		<li>
            <a href="/coinflip" class="navbar-href active">
                <div class="icons">
...
<div class="center">
    ...
    <div class="main-wrapper">
        ...
        <div class="controls">
            <div class="color-select">
                <button class="btn-multi active" data-value="t">
                    <img src="/img/misc/coin-t.png">
                </button>
                <button class="btn-multi" data-value="ct">
                    <img src="/img/misc/coin-ct.png">
                </button>
            </div>
            ...
            <div class="play">
                <button class="btn-play">Create</button>
            </div>
        </div>
        <div class="balance-latest">
            ...
            <div style="display: -ms-flexbox;display: flex;-ms-flex-align: center;align-items: center;-ms-flex-pack: distribute;justify-content: space-around;overflow: hidden;-ms-flex-wrap: wrap;flex-wrap: wrap; margin: 0 auto;position: relative;">Lobbies:</div>
        </div>
