...
<div id="sidebar-wrapper" style="width: 250px;">
  ...
  <li>
    <a class="expandable" title="" href="/user/deposit" style="border-right: 3px solid #ffcc01;">
      <span class="glyphicon collapsed-element">
            <img class="sidebar-icon" src="/assets/images/menu/deposit-skins-selected.png">
      </span>
  ...
  <div id="footer" style="width: 250px; display: block;">
            <div class="opskins-badge" style="text-align: center;">
				...
				<a id="vk" href="https://steamcommunity.com/groups/csgo_turbo" target="_blank"> <i class="fa fa-steam fa-lg" aria-hidden="true"></i></a>
            </div>
