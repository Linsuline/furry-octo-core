...
<head>
        ...
        <title>Store :: csgoclique.com</title>
...
<div class="icon">
<img src="/img/side-bar/shop.png" style="opacity: 1 !important;">
</div>
...
<div class="top-navigation">
    ...
    <div class="main-wrapper">
        ...
        <div class="inv-buttons">
            ...
            <div class="form-control select select-box" off="true">
        ...
        <div class="infos-selected">
            <div class="items-amount">Total items: <span class="value">0</span> (Maximum 20 items)</div>
            <div class="items-value">Total Worth: <span class="value">0</span></div>
            <div class="wager-amount">Wager Amount: <span class="value">{{Auth::user()->wager}}</span> (Maximum worth you can withdraw)</div>
