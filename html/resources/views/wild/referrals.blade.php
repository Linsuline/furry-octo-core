...
<div id="sidebar-wrapper" style="width: 250px;">
  ...
  <li>
    <a class="expandable" title="" href="/user/referrals" style="border-right: 3px solid #ffcc01;">
      <span class="glyphicon collapsed-element">
            <img class="sidebar-icon" src="/assets/images/menu/my-winnings-selected.png">
      </span>
